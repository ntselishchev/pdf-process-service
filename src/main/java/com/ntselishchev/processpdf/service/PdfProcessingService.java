...
public class PdfProcessingService {
    ...
    public void processPdf(String encodedString, HttpServletRequest request, HttpServletResponse response) {

        byte[] decodedBytes = ContentUtils.decodeStringToByteArray(encodedString);
